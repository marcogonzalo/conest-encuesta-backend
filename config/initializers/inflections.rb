...
ActiveSupport::Inflector.inflections do |inflect|
	...
	inflect.irregular 'oferta académica', 'oferta académica'
	inflect.irregular 'oferta_academica', 'oferta_academica'
	inflect.irregular 'OfertaAcademica', 'OfertaAcademica'
	inflect.irregular 'período académico', 'períodos académicos'
	inflect.irregular 'periodo_academico', 'periodos_academicos'
	inflect.irregular 'PeriodoAcademico', 'PeriodosAcademicos'
	inflect.irregular 'tipo de pregunta', 'tipos de pregunta'
	inflect.irregular 'tipo_pregunta', 'tipos_pregunta'
	inflect.irregular 'TipoPregunta', 'TiposPregunta'
	inflect.irregular 'control de consulta', 'control de consultas'
	inflect.irregular 'control_consulta', 'control_consultas'
	inflect.irregular 'ControlConsulta', 'ControlConsultas'
	inflect.irregular 'oferta en período', 'ofertas en período'
	inflect.irregular 'oferta_periodo', 'ofertas_periodo'
	inflect.irregular 'OfertaPeriodo', 'OfertasPeriodo'
