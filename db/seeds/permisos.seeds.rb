after 'roles' do
	...
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_historico_pregunta_de_materia', nombre: 'verReporteHistoricoDePreguntaEnMateria')
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_historico_comparado_de_materia', nombre: 'verReporteHistoricoComparadoDeMateria')
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_historico_completo_de_materia', nombre: 'verReporteHistoricoCompletoDeMateria')
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_periodo_comparado_de_materia', nombre: 'verReportePeriodoComparadoDeMateria')
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_periodo_completo_de_materia', nombre: 'verReportePeriodoCompletoDeMateria')

	# Permisos para consulta de reportes de docente
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_historico_pregunta_de_docente', nombre: 'verReporteHistoricoDePreguntaEnDocente')
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_historico_comparado_de_docente', nombre: 'verReporteHistoricoComparadoDeDocente')
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_historico_completo_de_docente', nombre: 'verReporteHistoricoCompletoDeDocente')
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_periodo_comparado_de_docente', nombre: 'verReportePeriodoComparadoDeDocente')
	Permiso.find_or_create_by(clase: 'Reporte', accion: 'reporte_periodo_completo_de_docente', nombre: 'verReportePeriodoCompletoDeDocente')
end